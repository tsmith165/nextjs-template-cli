...
function updateNextConfig(colors) {
    ...
    const updatedNextConfigContent = nextConfigContent.replace(/colorScheme:\s*{[\s\S]*?},/, `colorScheme: ${JSON.stringify(colors, null, 2)},`);
...
function extractColorCodes(url) {
    var _a;
    return (_a = url.split('/').pop()) === null || _a === void 0 ? void 0 : _a.split('-');
}
