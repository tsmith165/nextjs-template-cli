...
function updateFaviconSvg(svgData, colorScheme, colorSchemeOrder, projectDir) {
...
function updateLogoComponent(svgData, colorScheme, colorSchemeOrder, projectDir) {
...
function mapColorsToThemeColors(svgData, colorScheme, colorSchemeOrder) {
