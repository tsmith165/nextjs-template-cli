...
program
    ...
    execSync('yarn add next react react-dom tailwindcss @tailwindcss/typography postcss autoprefixer @types/react @types/react-dom inquirer');
    ...
    packageJson.scripts = Object.assign(Object.assign({}, packageJson.scripts), { 'update-colors': 'node scripts/update_colors/update_colors.mjs' });
